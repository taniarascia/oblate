<article id="post-<?php the_ID(); ?>">
	...
	<section class="single-body">
		<div class="small-container">
			...
			Hiya. I'm <a href="<?php echo site_url(); ?>/me">Tania</a>, a web developer from Chicago. Hope you enjoyed my ad-free, bullshit-free site. If you liked it, tell someone about it! Or <a href="<?php echo site_url(); ?>/contact">tell me</a>.</p>
