<article id="post-<?php the_ID(); ?>">
	...
	<section class="single-body">
		<div class="container">
			...
			<h2>The Author</h2>
			<p><small>If you've found this article helpful or interesting and think others would benefit from reading it, please share!</small></p>
				...
				<span class="fa-stack fa-lg">
				<i class="fa fa-circle fa-stack-2x reddit"></i>
				...
				<span class="fa-stack fa-lg">
				<i class="fa fa-circle fa-stack-2x hackernews"></i>
