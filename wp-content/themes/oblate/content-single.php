	...
	<section class="single-body">
		...
		<div class="excerpt"><?php the_excerpt(); ?></div>
			...
			<div class="author">
				...
				<p>You know what I stand for, and you know my commitment to you - <strong>no bullshit, no sponsored posts, no pop ups, no blocked content, ads, schemes, tactics, or gimmicks. Just free, quality content. <mark>Please support me with a coffee</mark></strong>!</p>
				
				<div class="author-options">
					<div>
						<h3>I really appreciate your support</h3>
						<p><a class="button paypal-button" href="https://ko-fi.com/taniarascia" target="_blank">Buy me a coffee</a></p>
					</div>
				</div>
			</div>
