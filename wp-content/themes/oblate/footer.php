...
<footer class="footer">
	...
	<a href="http://codepen.com/taniarascia" class="social-icon"><i class="fa fa-codepen fa-2x"></i></a>
	<a href="http://stackoverflow.com/users/4541434/tania-rascia" class="social-icon"><i class="fa fa-stack-overflow fa-2x"></i></a>
</footer>
