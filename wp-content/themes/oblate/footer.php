...
<footer class="new-moon">
  ...
  <a href="https://taniarascia.github.io/new-moon/" target="_blank"><img src="<?php echo site_url(); ?>/wp-content/uploads/newmoon-150x150.png" class="nm-logo"></a>
    ...
    <p class="programs">
      ...
      <a target="_blank" href="https://atom.io/themes/new-moon-atom-syntax"><img src="<?php echo site_url(); ?>/wp-content/uploads/atom-150x150.png"></a>
...
<footer class="footer">
 <div class="container flex-container">
    ...
    <p><span class="green">My website is completely free</span> and ad-free. Please consider donating. I want to make the internet a better place and encourage others to do so, as well.</p>
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
			...
			">
			<input type="submit" name="submit" alt="PayPal - The safer, easier way to pay online!" class="button paypal-button" value="Donate with PayPal">
			</form>
