...
function oblate_scripts() {
	...
	wp_enqueue_style( 'style', get_template_directory_uri() . '/css/main.css?05-25-2017' );
	...
	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/script.js?05-25-2017', array(), '1.0.0', true );
}
