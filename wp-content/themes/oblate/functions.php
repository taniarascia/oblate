...
function oblate_scripts() {
	...
	wp_enqueue_style( 'style', get_template_directory_uri() . '/css/main.css?01-17-2017x9' );
...
function load_fonts() {
	wp_register_style( 'All', '//fonts.googleapis.com/css?family=PT+Serif:400,700|Heebo:400,500,700|Roboto+Mono:400|Nunito+Sans:700' );
