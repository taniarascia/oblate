...
<section class="tutorials">
	<div class="tutorials-grid">
		...
		<a href="<?php echo site_url(); ?>/how-to-use-the-command-line-for-apple-macos-and-linux/" id="shell-tutorial" class="tutorials-cell">
			<img src="<?php echo site_url(); ?>/wp-content/uploads/term.png" class="responsive-image" alt="Command Line">
			<h3>Command Line</h3>
		</a>
		<a href="<?php echo site_url(); ?>/javascript-day-one" id="js-tutorial" class="tutorials-cell">
			<img src="<?php echo site_url(); ?>/wp-content/uploads/js-150x150.png" class="responsive-image" alt="JavaScript">
			<h3>JavaScript</h3>
		</a>
